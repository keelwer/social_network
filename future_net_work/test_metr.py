...
def test_trade_price():
    engine = str()
    price = str(Metrics.get_trades(engine=engine, columns=['price'], evdate='02.12.2019', tradeno='352303634'))
...
def test_client_instr():
    ...
    engine = str()
    tradeEvno = str(Metrics.get_events(engine=engine, top='top (1)', columns=['evno'], evdate='02.12.2019',
    ...
    secboard = str(Metrics.get_trades(engine=engine, top='top (1)', columns=['secboard'], evdate='02.12.2019',
                                      tradeno='352303634'))
    seccode = str(Metrics.get_trades(engine=engine, top='top (1)', columns=['seccode'], evdate='02.12.2019',
                                     tradeno='352303634'))
    ...
    message_in_signals = str(Metrics.get_custom_signals(engine=engine, columns=['message'], taskid='126', criteriaid='93',
                                                        tsno='4050634109'))
